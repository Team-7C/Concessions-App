        ...
        return (
            <div className="admin_main">
                <div className = "form">
                    ...
                    <button onClick={(a) => {a.preventDefault(); this.checkCredentials();}}> Submit Credentials </button>

					<button onClick={(a) => {a.preventDefault();  if (this.state.nextPage === 'admin_display') {
